...
export default function OldStudentForm({
    ...
    const handleSubmit = () => {
        ...
        axiosClientRegistrar
            .post(`/enroll/oldstudent/${formValues.id}`, formData, {
                headers: {
            ...
            .then(() => {
                ...
                if (toast.isActive(toastId)) {
                    ...
                    const id = toast.success("Successfully Enrolled Student");
                    setToastId(id);
                }
            })
            .catch((err) => {
                ...
                if (response && response.status === 422) {
                    const dataError = response.data.errors; // Access the errors
                    ...
                    // Display the toast notification for errors
                    if (toast.isActive(toastId)) {
                        toast.update(toastId, {
                            render: errorMessage,
                    ...
                    if (toast.isActive(toastId)) {
                        ...
                        const id = toast.error(genericErrorMessage);
                        setToastId(id);
                    }
                }
            });
                        ...
                        >
                            ...
                            <Tab eventKey="profile" title="Family Background">
                                ...
                                <div className="d-flex flex-wrap gap-5 border p-3 border-2 rounded">
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Label>
                                            Email Address/Social Media Account
                                        </Form.Label>
                                        <Form.Control
                                            type="text"
                                            name="father_social"
