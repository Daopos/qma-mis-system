...
export default function EmployeeResetForm() {
    ...
    const handleSendCode = async (e) => {
        ...
        try {
            const response = await axiosClientAll.post("/resetcode/employee", {
                email,
            });
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            const response = await axiosClientAll.post("/resetpass/employee", {
                email,
                code,
